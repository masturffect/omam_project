...
import {Hist} from './History_01.jpg'
...
Then there were the plug-ins. So many plug-ins (Neatline itself being a plug-in). And each plug-in layered another set of limitations on visualizing the project’s data. For example, the ‘CSV Import’ plug-in enabled me to upload data contained in Excel spreadsheets, but utilized Dublin Core standards for data categorization, which seriously hampered my ability to include historical nuance and ambiguity.  A ‘Neatline Maps’ plug-in was necessary to display useful indicators such as county lines, topographic identifiers, and historical demarcations. Alas, I never did figure out how to wed downloaded shapefiles of historic transportation networks—such as the 1861 railroad system—with this plug-in. Consequently, my analysis suffered (guerrillas frequently attacked the Union army’s logistics network). 
<img src={Hist} alt="History"/>
